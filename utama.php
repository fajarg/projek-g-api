...
<body>
        <header>
                <div class="main">
                        <ul>
                                <li><a href="Tambah/tambah.php" class="active"><p style="font-family: century gothic">Tambah Gunung</a></li>
                                 <li><a href="cetak.php" class="active" target ="_blank"><p style="font-family: century gothic" >Cetak</a></li>
                                 <li><a href="Highcharts/latihan/dataku.php" class="active"><p style="font-family: century gothic" >Grafik</a></li>
                                <li>
